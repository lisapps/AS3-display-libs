...
// container. This will affect tweens.
	...
	import com.laz.display.TDRectangle;
	...
	public class LButton extends Sprite
	{
		...
		private var btf:LTextVO;
		private var field:LText;
		private var baseFillRect:LRectangle;
		private var overFillRect:LRectangle;
		private var downFillRect:LRectangle;
		private var baseTDfillRect:LRectangle;
		private var overTDfillRect:LRectangle;
		private var downTDfillRect:LRectangle;
		private var glassFillRect:LRectangle;
		private var glassFillOverRect:LRectangle;
		private var glassFillDownRect:LRectangle;
		private var hiliteRect:LRectangle;
		private var loliteRect:LRectangle;
		...
		public function LButton(oButton:LButtonVO)
		...
		private function init()
		{
			...
			if(tbToggle == false)
			{
				...
				rect.fRound		 = nbRound;
				rect.fLineAlpha	 = .01;
				var hitRect = new LRectangle(rect);
		...
		private function drawFill()
		{
			if(nW == 0 && nH == 0) //if no button size is provided,
			{
				...
				{	//check to see if rollover color is not set
						...
						var fillRect:LRectangle = new LRectangle(fill);
						imageContainer.addChild(fillRect);

					if(nBtnOver != 0)
					{
						var overFill:LRectVO = new LRectVO();
						...
						overFillRect = new LRectangle(overFill);
						imageContainer.addChildAt(overFillRect, 1);
						overFillRect.visible = false;
						
						var downFill:LRectVO = new LRectVO();
						...
						downFillRect = new LRectangle(downFill);
					...
					//Draw 3D rect
						var tDfill:LRectVO = new LRectVO();
					...
					var glassFill:LRectVO = new LRectVO();
						...
						glassFillRect = new LRectangle(glassFill);
						imageContainer.addChildAt(glassFillRect, 0);
						//over
					var glassFillOver:LRectVO = new LRectVO();
						...
						glassFillOverRect = new LRectangle(glassFillOver);
						imageContainer.addChildAt(glassFillOverRect, 1);
						glassFillOverRect.visible	= false;
						
						//down
					var glassFillDown:LRectVO = new LRectVO();
						...
						glassFillDownRect = new LRectangle(glassFillDown);
						...
						var hilite:LRectVO 	= new LRectVO();
						...
						loliteRect = new LRectangle(lolite);
						loliteRect.alpha = .2;
