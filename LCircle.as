...
// To use, call an instance of LCircleVO and use that object to set
...
// means that the container will still be at 0,0 but the circle will have moved inside the container.
	...
	public class LCircle extends MovieClip
	{
		...
		public function LCircle(oCirc:Object)
		{
		...
		public function draw()
		{
            ...
            if(_tFillColors) 
			{
                ...
                child.graphics.endFill();
   				trace("child.x in LCircle: " + child.x);
   				addChild(child);
			}
